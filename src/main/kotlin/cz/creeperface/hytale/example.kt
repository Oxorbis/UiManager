...
class BwData(time: String) : BaseObservable() {
            ...
            decoratedContainer {
                ...
                content {
                    ...
                    group {
                        ...
                        numberInput("X", "%server.customUI.configureInstanceBlockPage.positionOffset.x")
                        numberInput("Y", "%server.customUI.configureInstanceBlockPage.positionOffset.y")
                        numberInput("Z", "%server.customUI.configureInstanceBlockPage.positionOffset.z")
                    }
                    ...
                    group {
                        ...
                        numberInput("Pitch", "%server.customUI.configureInstanceBlockPage.rotation.pitch")
                        numberInput("Yaw", "%server.customUI.configureInstanceBlockPage.rotation.yaw")
                        numberInput("Roll", "%server.customUI.configureInstanceBlockPage.rotation.roll")
                    }
                    ...
                    numberInput(
                        id = "RemoveBlockAfter",
                        labelText = "%server.customUI.configureInstanceBlockPage.removeBlockAfter",
                        isVisible = true,
                        leftOffset = 0
                    )
                    ...
                    group {
                        ...
                        group {
                            ...
                            label {
                                ...
                                trade?.let {
                                    text = trade.output.quantity.toString()
                                }
                            }
                        }
                    }
                        ...
                        group {
                            ...
                            group {
                                ...
                                label {
                                    ...
                                    trade?.let {
                                        text = trade.input.quantity.toString()
                                    }
                                }
                            }
                            ...
                            label {
                                ...
                                text = "Have: " + (trade?.playerInventoryCount ?: 0)
                            }
                        }
                    }
