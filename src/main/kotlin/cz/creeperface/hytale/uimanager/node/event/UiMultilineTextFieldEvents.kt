...
public fun UiMultilineTextField.onValidate(vararg boundProperties: KProperty0<Any?>, action: (context: EventContext) -> Unit) {
  addEventBinding(CustomUIEventBindingType.Validating, requireNotNull(this.id), *boundProperties, action = action)
}

public fun UiMultilineTextField.onValidate(action: (`value`: String?) -> Unit) {
  addEventBinding(CustomUIEventBindingType.Validating, requireNotNull(this.id), this::value) {
    ctx -> action(ctx.getData(this::value))
  }
}

public fun UiMultilineTextField.submitOnValidate(formContext: UiFormContext<*>) {
  formContext.form.bindSubmit(this, CustomUIEventBindingType.Validating)
}

public fun <T1> UiMultilineTextField.onValidate(prop1: KProperty0<T1>, action: (pT1: T1) -> Unit) {
...
public fun <T1, T2> UiMultilineTextField.onValidate(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
...
public fun <T1, T2, T3> UiMultilineTextField.onValidate(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  action: (
...
public fun <T1, T2, T3, T4> UiMultilineTextField.onValidate(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun <T1, T2, T3, T4, T5> UiMultilineTextField.onValidate(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun <T1> UiMultilineTextField.onValidate(prop1: KProperty0<T1>, action: (`value`: String?, p1: T1) -> Unit) {
...
public fun UiMultilineTextField.onDismiss(vararg boundProperties: KProperty0<Any?>, action: (context: EventContext) -> Unit) {
  addEventBinding(CustomUIEventBindingType.Dismissing, requireNotNull(this.id), *boundProperties, action = action)
}

public fun UiMultilineTextField.onDismiss(action: (`value`: String?) -> Unit) {
  addEventBinding(CustomUIEventBindingType.Dismissing, requireNotNull(this.id), this::value) {
    ctx -> action(ctx.getData(this::value))
  }
}

public fun UiMultilineTextField.submitOnDismiss(formContext: UiFormContext<*>) {
  formContext.form.bindSubmit(this, CustomUIEventBindingType.Dismissing)
}

public fun <T1> UiMultilineTextField.onDismiss(prop1: KProperty0<T1>, action: (pT1: T1) -> Unit) {
...
public fun <T1, T2> UiMultilineTextField.onDismiss(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  action: (pT1: T1, pT2: T2) -> Unit,
) {
...
public fun <T1, T2, T3> UiMultilineTextField.onDismiss(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  action: (
...
public fun <T1, T2, T3, T4> UiMultilineTextField.onDismiss(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun <T1, T2, T3, T4, T5> UiMultilineTextField.onDismiss(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun <T1> UiMultilineTextField.onDismiss(prop1: KProperty0<T1>, action: (`value`: String?, p1: T1) -> Unit) {
...
public fun UiMultilineTextField.onFocusLost(vararg boundProperties: KProperty0<Any?>, action: (context: EventContext) -> Unit) {
  addEventBinding(CustomUIEventBindingType.FocusLost, requireNotNull(this.id), *boundProperties, action = action)
}

public fun UiMultilineTextField.onFocusLost(action: (`value`: String?) -> Unit) {
  addEventBinding(CustomUIEventBindingType.FocusLost, requireNotNull(this.id), this::value) {
    ctx -> action(ctx.getData(this::value))
  }
}

public fun UiMultilineTextField.submitOnFocusLost(formContext: UiFormContext<*>) {
  formContext.form.bindSubmit(this, CustomUIEventBindingType.FocusLost)
}

public fun <T1> UiMultilineTextField.onFocusLost(prop1: KProperty0<T1>, action: (pT1: T1) -> Unit) {
...
public fun <T1, T2> UiMultilineTextField.onFocusLost(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  action: (pT1: T1, pT2: T2) -> Unit,
) {
...
public fun <T1, T2, T3> UiMultilineTextField.onFocusLost(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  action: (
...
public fun <T1, T2, T3, T4> UiMultilineTextField.onFocusLost(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun <T1, T2, T3, T4, T5> UiMultilineTextField.onFocusLost(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun <T1> UiMultilineTextField.onFocusLost(prop1: KProperty0<T1>, action: (`value`: String?, p1: T1) -> Unit) {
...
public fun UiMultilineTextField.onFocusGain(vararg boundProperties: KProperty0<Any?>, action: (context: EventContext) -> Unit) {
  addEventBinding(CustomUIEventBindingType.FocusGained, requireNotNull(this.id), *boundProperties, action = action)
}

public fun UiMultilineTextField.onFocusGain(action: (`value`: String?) -> Unit) {
  addEventBinding(CustomUIEventBindingType.FocusGained, requireNotNull(this.id), this::value) {
    ctx -> action(ctx.getData(this::value))
  }
}

public fun UiMultilineTextField.submitOnFocusGain(formContext: UiFormContext<*>) {
  formContext.form.bindSubmit(this, CustomUIEventBindingType.FocusGained)
}

public fun <T1> UiMultilineTextField.onFocusGain(prop1: KProperty0<T1>, action: (pT1: T1) -> Unit) {
...
public fun <T1, T2> UiMultilineTextField.onFocusGain(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  action: (pT1: T1, pT2: T2) -> Unit,
) {
...
public fun <T1, T2, T3> UiMultilineTextField.onFocusGain(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  action: (
...
public fun <T1, T2, T3, T4> UiMultilineTextField.onFocusGain(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun <T1, T2, T3, T4, T5> UiMultilineTextField.onFocusGain(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun <T1> UiMultilineTextField.onFocusGain(prop1: KProperty0<T1>, action: (`value`: String?, p1: T1) -> Unit) {
...
public fun UiMultilineTextField.onValueChange(vararg boundProperties: KProperty0<Any?>, action: (context: EventContext) -> Unit) {
  addEventBinding(CustomUIEventBindingType.ValueChanged, requireNotNull(this.id), *boundProperties, action = action)
}

public fun UiMultilineTextField.onValueChange(action: (`value`: String?) -> Unit) {
  addEventBinding(CustomUIEventBindingType.ValueChanged, requireNotNull(this.id), this::value) {
    ctx -> action(ctx.getData(this::value))
  }
}

public fun UiMultilineTextField.submitOnValueChange(formContext: UiFormContext<*>) {
  formContext.form.bindSubmit(this, CustomUIEventBindingType.ValueChanged)
}

public fun <T1> UiMultilineTextField.onValueChange(prop1: KProperty0<T1>, action: (pT1: T1) -> Unit) {
...
public fun <T1, T2> UiMultilineTextField.onValueChange(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  action: (pT1: T1, pT2: T2) -> Unit,
) {
...
public fun <T1, T2, T3> UiMultilineTextField.onValueChange(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  action: (
...
public fun <T1, T2, T3, T4> UiMultilineTextField.onValueChange(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun <T1, T2, T3, T4, T5> UiMultilineTextField.onValueChange(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun <T1> UiMultilineTextField.onValueChange(prop1: KProperty0<T1>, action: (`value`: String?, p1: T1) -> Unit) {
