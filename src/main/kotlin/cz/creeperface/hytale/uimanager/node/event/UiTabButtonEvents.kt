...
public fun UiTabButton.onActivate(vararg boundProperties: KProperty0<Any?>, action: (context: EventContext) -> Unit) {
  addEventBinding(CustomUIEventBindingType.Activating, requireNotNull(this.id), *boundProperties, action = action)
}

public fun UiTabButton.submitOnActivate(formContext: UiFormContext<*>) {
  formContext.form.bindSubmit(this, CustomUIEventBindingType.Activating)
}

public fun <T1> UiTabButton.onActivate(prop1: KProperty0<T1>, action: (pT1: T1) -> Unit) {
...
public fun <T1, T2> UiTabButton.onActivate(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
...
public fun <T1, T2, T3> UiTabButton.onActivate(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  action: (
...
public fun <T1, T2, T3, T4> UiTabButton.onActivate(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun <T1, T2, T3, T4, T5> UiTabButton.onActivate(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun UiTabButton.onDoubleClick(vararg boundProperties: KProperty0<Any?>, action: (context: EventContext) -> Unit) {
  addEventBinding(CustomUIEventBindingType.DoubleClicking, requireNotNull(this.id), *boundProperties, action = action)
}

public fun UiTabButton.submitOnDoubleClick(formContext: UiFormContext<*>) {
  formContext.form.bindSubmit(this, CustomUIEventBindingType.DoubleClicking)
}

public fun <T1> UiTabButton.onDoubleClick(prop1: KProperty0<T1>, action: (pT1: T1) -> Unit) {
...
public fun <T1, T2> UiTabButton.onDoubleClick(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  action: (pT1: T1, pT2: T2) -> Unit,
) {
...
public fun <T1, T2, T3> UiTabButton.onDoubleClick(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  action: (
...
public fun <T1, T2, T3, T4> UiTabButton.onDoubleClick(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun <T1, T2, T3, T4, T5> UiTabButton.onDoubleClick(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun UiTabButton.onRightClick(vararg boundProperties: KProperty0<Any?>, action: (context: EventContext) -> Unit) {
  addEventBinding(CustomUIEventBindingType.RightClicking, requireNotNull(this.id), *boundProperties, action = action)
}

public fun UiTabButton.submitOnRightClick(formContext: UiFormContext<*>) {
  formContext.form.bindSubmit(this, CustomUIEventBindingType.RightClicking)
}

public fun <T1> UiTabButton.onRightClick(prop1: KProperty0<T1>, action: (pT1: T1) -> Unit) {
...
public fun <T1, T2> UiTabButton.onRightClick(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  action: (pT1: T1, pT2: T2) -> Unit,
) {
...
public fun <T1, T2, T3> UiTabButton.onRightClick(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  action: (
...
public fun <T1, T2, T3, T4> UiTabButton.onRightClick(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun <T1, T2, T3, T4, T5> UiTabButton.onRightClick(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun UiTabButton.onMouseEnter(vararg boundProperties: KProperty0<Any?>, action: (context: EventContext) -> Unit) {
  addEventBinding(CustomUIEventBindingType.MouseEntered, requireNotNull(this.id), *boundProperties, action = action)
}

public fun UiTabButton.submitOnMouseEnter(formContext: UiFormContext<*>) {
  formContext.form.bindSubmit(this, CustomUIEventBindingType.MouseEntered)
}

public fun <T1> UiTabButton.onMouseEnter(prop1: KProperty0<T1>, action: (pT1: T1) -> Unit) {
...
public fun <T1, T2> UiTabButton.onMouseEnter(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  action: (pT1: T1, pT2: T2) -> Unit,
) {
...
public fun <T1, T2, T3> UiTabButton.onMouseEnter(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  action: (
...
public fun <T1, T2, T3, T4> UiTabButton.onMouseEnter(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun <T1, T2, T3, T4, T5> UiTabButton.onMouseEnter(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun UiTabButton.onMouseExit(vararg boundProperties: KProperty0<Any?>, action: (context: EventContext) -> Unit) {
  addEventBinding(CustomUIEventBindingType.MouseExited, requireNotNull(this.id), *boundProperties, action = action)
}

public fun UiTabButton.submitOnMouseExit(formContext: UiFormContext<*>) {
  formContext.form.bindSubmit(this, CustomUIEventBindingType.MouseExited)
}

public fun <T1> UiTabButton.onMouseExit(prop1: KProperty0<T1>, action: (pT1: T1) -> Unit) {
...
public fun <T1, T2> UiTabButton.onMouseExit(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  action: (pT1: T1, pT2: T2) -> Unit,
) {
...
public fun <T1, T2, T3> UiTabButton.onMouseExit(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  action: (
...
public fun <T1, T2, T3, T4> UiTabButton.onMouseExit(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun <T1, T2, T3, T4, T5> UiTabButton.onMouseExit(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
