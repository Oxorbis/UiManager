...
public fun UiActionButton.onActivate(vararg boundProperties: KProperty0<Any?>, action: (context: EventContext) -> Unit) {
  addEventBinding(CustomUIEventBindingType.Activating, requireNotNull(this.id), *boundProperties, action = action)
}

public fun UiActionButton.submitOnActivate(formContext: UiFormContext<*>) {
  formContext.form.bindSubmit(this, CustomUIEventBindingType.Activating)
}

public fun <T1> UiActionButton.onActivate(prop1: KProperty0<T1>, action: (pT1: T1) -> Unit) {
...
public fun <T1, T2> UiActionButton.onActivate(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
...
public fun <T1, T2, T3> UiActionButton.onActivate(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  action: (
...
public fun <T1, T2, T3, T4> UiActionButton.onActivate(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun <T1, T2, T3, T4, T5> UiActionButton.onActivate(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun UiActionButton.onDoubleClick(vararg boundProperties: KProperty0<Any?>, action: (context: EventContext) -> Unit) {
  addEventBinding(CustomUIEventBindingType.DoubleClicking, requireNotNull(this.id), *boundProperties, action = action)
}

public fun UiActionButton.submitOnDoubleClick(formContext: UiFormContext<*>) {
  formContext.form.bindSubmit(this, CustomUIEventBindingType.DoubleClicking)
}

public fun <T1> UiActionButton.onDoubleClick(prop1: KProperty0<T1>, action: (pT1: T1) -> Unit) {
...
public fun <T1, T2> UiActionButton.onDoubleClick(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  action: (pT1: T1, pT2: T2) -> Unit,
) {
...
public fun <T1, T2, T3> UiActionButton.onDoubleClick(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  action: (
...
public fun <T1, T2, T3, T4> UiActionButton.onDoubleClick(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun <T1, T2, T3, T4, T5> UiActionButton.onDoubleClick(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun UiActionButton.onRightClick(vararg boundProperties: KProperty0<Any?>, action: (context: EventContext) -> Unit) {
  addEventBinding(CustomUIEventBindingType.RightClicking, requireNotNull(this.id), *boundProperties, action = action)
}

public fun UiActionButton.submitOnRightClick(formContext: UiFormContext<*>) {
  formContext.form.bindSubmit(this, CustomUIEventBindingType.RightClicking)
}

public fun <T1> UiActionButton.onRightClick(prop1: KProperty0<T1>, action: (pT1: T1) -> Unit) {
...
public fun <T1, T2> UiActionButton.onRightClick(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  action: (pT1: T1, pT2: T2) -> Unit,
) {
...
public fun <T1, T2, T3> UiActionButton.onRightClick(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  action: (
...
public fun <T1, T2, T3, T4> UiActionButton.onRightClick(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun <T1, T2, T3, T4, T5> UiActionButton.onRightClick(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun UiActionButton.onMouseEnter(vararg boundProperties: KProperty0<Any?>, action: (context: EventContext) -> Unit) {
  addEventBinding(CustomUIEventBindingType.MouseEntered, requireNotNull(this.id), *boundProperties, action = action)
}

public fun UiActionButton.submitOnMouseEnter(formContext: UiFormContext<*>) {
  formContext.form.bindSubmit(this, CustomUIEventBindingType.MouseEntered)
}

public fun <T1> UiActionButton.onMouseEnter(prop1: KProperty0<T1>, action: (pT1: T1) -> Unit) {
...
public fun <T1, T2> UiActionButton.onMouseEnter(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  action: (pT1: T1, pT2: T2) -> Unit,
) {
...
public fun <T1, T2, T3> UiActionButton.onMouseEnter(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  action: (
...
public fun <T1, T2, T3, T4> UiActionButton.onMouseEnter(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun <T1, T2, T3, T4, T5> UiActionButton.onMouseEnter(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun UiActionButton.onMouseExit(vararg boundProperties: KProperty0<Any?>, action: (context: EventContext) -> Unit) {
  addEventBinding(CustomUIEventBindingType.MouseExited, requireNotNull(this.id), *boundProperties, action = action)
}

public fun UiActionButton.submitOnMouseExit(formContext: UiFormContext<*>) {
  formContext.form.bindSubmit(this, CustomUIEventBindingType.MouseExited)
}

public fun <T1> UiActionButton.onMouseExit(prop1: KProperty0<T1>, action: (pT1: T1) -> Unit) {
...
public fun <T1, T2> UiActionButton.onMouseExit(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  action: (pT1: T1, pT2: T2) -> Unit,
) {
...
public fun <T1, T2, T3> UiActionButton.onMouseExit(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  action: (
...
public fun <T1, T2, T3, T4> UiActionButton.onMouseExit(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
...
public fun <T1, T2, T3, T4, T5> UiActionButton.onMouseExit(
  prop1: KProperty0<T1>,
  prop2: KProperty0<T2>,
  prop3: KProperty0<T3>,
  prop4: KProperty0<T4>,
